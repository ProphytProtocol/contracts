/// Prophyt Walrus Proof NFT Module
/// Properly integrates with Walrus SDK Blob type
/// NFT references actual Walrus Blob objects for proof images
...
module prophyt::walrus_proof_nft {
    ...
    /// Bet Proof NFT - issued when user places a bet
    public struct BetProofNFT has key, store {
        ...
        transaction_fee: u64,
        bet_timestamp: u64,
        bet_proof_blob_address: address,  // Walrus Blob with bet details
        image_url: String,  // Portfolio image URL from backend
        image_blob_id: String,  // Walrus blob ID for the image
        minted_at: u64,
    }

    /// Winning Proof NFT - issued when user claims winnings
    public struct WinningProofNFT has key, store {
        id: UID,
        market_id: u64,
        market_question: String,
        bet_id: u64,
        position: bool,  // Winning position
        ...
        winning_proof_blob_address: address,  // Walrus Blob with resolution proof
        image_url: String,  // Portfolio image URL from backend
        image_blob_id: String,  // Walrus blob ID for the image
        minted_at: u64,
    }

    /// Market Proof NFT - references Walrus Blob (deprecated, kept for compatibility)
    public struct MarketProofNFT has key, store {
        ...
        winning_amount: u64,
        yield_earned: u64,
        proof_blob_address: address,  // Address of shared Walrus Blob
        resolution_timestamp: u64,
        minted_at: u64,
    }

    /// Wrapper for Walrus Blob - allows shared storage on-chain
    ...
    /// Wrap Walrus Blob for shared storage
    ...
    /// Mint Bet Proof NFT when user places a bet
    /// Backend should generate the portfolio image first and provide image_url and image_blob_id
    public fun mint_bet_proof_nft(
        ...
        bet_timestamp: u64,
        bet_proof_blob_address: address,  // Walrus blob with bet details
        image_url: String,  // Generated portfolio image URL from backend
        image_blob_id: String,  // Walrus blob ID for the portfolio image
        minted_at: u64,
        recipient: address,
        ctx: &mut TxContext
    ): address {
    ...
    /// Mint Winning Proof NFT when user claims winnings
    /// Backend should generate the winning portfolio image first and provide image_url and image_blob_id
    public fun mint_winning_proof_nft(
        ...
        claimed_timestamp: u64,
        winning_proof_blob_address: address,  // Walrus blob with resolution proof
        image_url: String,  // Generated winning portfolio image URL from backend
        image_blob_id: String,  // Walrus blob ID for the winning portfolio image
        minted_at: u64,
        recipient: address,
        ctx: &mut TxContext
    ): address {
    ...
    /// Mint a proof NFT for market winner
    public fun mint_proof_nft(
        ...
        winning_amount: u64,
        yield_earned: u64,
        proof_blob_address: address,  // Address of WrappedProofBlob
        resolution_timestamp: u64,
        minted_at: u64,
        recipient: address,
        ctx: &mut TxContext
    ...
    // Accessor functions for MarketProofNFT
    ...
    // Accessor functions for BetProofNFT
    ...
    // Accessor functions for WinningProofNFT
    ...
    // Accessor functions for WrappedProofBlob
