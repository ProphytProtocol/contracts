/// Staking Protocol Interface
/// Defines the common interface that all staking protocol adapters must implement
module prophyt::staking_protocol {
    use std::string::String;

    /// Protocol information structure
    public struct ProtocolInfo has store, copy, drop {
        protocol_type: u8,
    ...
    /// Protocol metrics for scoring
    public struct ProtocolMetrics has store, copy, drop {
        apy: u64,
        tvl: u64,
        risk_score: u64,
        uptime_score: u64,
